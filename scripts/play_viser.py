...
Usage::
    ...
    uv run scripts/play_viser.py task=go2/go2_joystick_flat/mujoco interactive.action_mode=zero

    # With a trained policy
    uv run scripts/play_viser.py task=go2/go2_joystick_flat/mujoco interactive.action_mode=policy

    # Multiple environments with env switching
    uv run scripts/play_viser.py task=go2/go2_joystick_flat/mujoco algo.num_envs=4 viser.port=8080

    # Motion tracking task
    uv run scripts/play_viser.py task=g1/g1_motion_tracking/mujoco interactive.action_mode=policy
